...
Engine.initObject("Human", "Mover", function() {
  var Human = Mover.extend({
    ...
    canStand: function() {
      return this.weapon.canStand();
    },

    getStandState: function() {
    ...
    isMobile: function() {
      return this.weapon.isMobile() && !this.isSpotter();
    },
    ...
    stoppedShooting: function() {
      this.lastStoppedShooting = new Date().getTime();
    },
    ...
    isDying: function() {
      return this.stateOfBeing == Human.DYING;
    },
    ...
    getGunAngle: function() {
      return Human.COORDINATES[this.direction][this.standState][this.weapon.name]["gunAngle"];
    },
    getRelativeGunTip: function(weaponName) {
      return Human.COORDINATES[this.direction][this.standState][weaponName]["gunTip"];
    },
    ...
    COORDINATES: {
      "Left": {
        "Standing": {
          "GrenadeLauncher": {
            "gunTip": new Point2D(23, 2),
            "gunAngle": 330
          },
          "M9": {
            "gunTip": new Point2D(07, 06),
            "gunAngle": 270
          },
          "Mac10": {
            "gunTip": new Point2D(07, 04),
            "gunAngle": 270
          },
          "SPAS": {
            "gunTip": new Point2D(07, 09),
            "gunAngle": 270
          }
        },
        "Crouching": {
          "GrenadeLauncher": {
            "gunTip": new Point2D(10, 0),
            "gunAngle": 330
          },
          "M9": {
            "gunTip": new Point2D(07, 05),
            "gunAngle": 270
          },
          "Mac10": {
            "gunTip": new Point2D(07, 04),
          ...
          "SPAS": {
            "gunTip": new Point2D(07, 08),
            "gunAngle": 270
          },
          "Mortar": {
            "gunTip": new Point2D(11, 08),
            "gunAngle": 345
          },
        }
      },
      "Right": {
        "Standing": {
          "GrenadeLauncher": {
            "gunTip": new Point2D(10, 2),
            "gunAngle": 30
          },
          "M9": {
            "gunTip": new Point2D(40, 06),
            "gunAngle": 90
          },
          "Mac10": {
            "gunTip": new Point2D(40, 04),
            "gunAngle": 90
          },
          "SPAS": {
            "gunTip": new Point2D(40, 09),
            "gunAngle": 90
          },
        },
        "Crouching": {
          "GrenadeLauncher": {
            "gunTip": new Point2D(23, 0),
            "gunAngle": 30
          },
          "M9": {
            "gunTip": new Point2D(40, 05),
            "gunAngle": 90
          },
          "Mac10": {
            "gunTip": new Point2D(40, 04),
